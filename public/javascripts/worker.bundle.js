...
/***/ (function(module, exports, __webpack_require__) {
	...
	function cacheRequests(cache) {
	  ...
	  return cache.addAll(URLS_TO_CACHE.concat(([".DS_Store",".env",".env_example",".travis.yml","LICENSE","app.js","gulpfile.js","models","package-lock.json","public","routes","updates","views","yarn.lock"])));
	}
